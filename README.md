...
1. 打开 [Simaritan 下载页](https://github.com/Azvf/Simaritan-Release/releases)。
2. 进入最上方的新版本，在 **Assets** 中点击唯一的 `.exe` 安装包。
3. 下载完成后双击安装；以后发布新版本时，继续覆盖安装即可。
...
- 先打开 **设置 → 应用 → 导出调试日志**，生成经过脱敏的诊断 ZIP。
- 再进入 **设置 → 关于**，通过 QQ 群或 Discord 反馈，并附上问题描述和日志。
